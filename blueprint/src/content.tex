...
\begin{theorem}[Steiner gap between the bounds]
    \label{thm:minkowskiSteinerGap}
    \lean{Moser.CompactnessOutline.minkowskiSteinerGap}
...
\begin{remark}[Perimeter bound]
    ...
    \uses{def:minimalCover, thm:minkowskiSteinerGap}
    To turn Theorem~\ref{thm:minkowskiSteinerGap} into an effective error bound one needs
...
\begin{theorem}[Approximating the Moser number]
    ...
    \uses{def:moserNumber, thm:finiteEpsilonNet, thm:lowerBound, thm:upperBound, thm:minkowskiSteinerGap, rem:perimeterBound}
...
\end{theorem}
\begin{proof}
    \uses{thm:lowerBound, thm:upperBound, thm:minkowskiSteinerGap}
    ...
    By Theorem~\ref{thm:minkowskiSteinerGap} the gap between these bounds equals
